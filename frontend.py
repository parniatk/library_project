...
#=================== Listbox = آیتم ها در اینجا قرار میگیرن =============
list1 = Listbox(window, width=35, height=6)

#rowspan , columnspan = برای مرتب سازی استفاده میشه
...
# قرار دادن دکمه هایی برای اعمال تغییرات
def view_command():
    clear_list()
    books = backend.view()
    fill_list(books)
...
def search_command():
    ...
    fill_list(books)
b2= Button(window, text="search", width=12, command=lambda :search_command())
